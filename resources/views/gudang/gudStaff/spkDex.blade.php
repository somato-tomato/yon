...
@section('content')
                ...
                <div class="card shadow">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col-8">
                                <h3 class="mb-0">SPK Pengajuan</h3>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-hover table-flush" style="width: 100%" id="spks-table">
                            <thead>
                            <tr>
    ...
    <script>
        $(function() {
            $('#spks-table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{ route('gudstaff.spkData') }}',
                columns: [
