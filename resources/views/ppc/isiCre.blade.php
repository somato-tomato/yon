    ...
    <div class="content">
        <div class="row justify-content-center">
            <div class="col-md-12 my-form">
                <form action="{{ route('ppcisi.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div id="dynamicTable">
                                <div hidden class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="addmore[0][idPPC]" id="idPPC" value="{{$id->id}}">
                                </div>
    ...
    <script type="text/javascript">
        ...
        $("#add").click(function(){
            ...
            $("#dynamicTable").append(
                ...
                '<div hidden class="form-group">' +
                '<label for="idPPC">idPPC</label>' +
                '<input readonly type="text" class="form-control" name="addmore['+i+'][idPPC]" id="idPPC" value="{{ $id->id }}">' +
                '</div>' +
                '<div class="form-group">' +
                '<label for="namaMaterial">Nama Material</label>' +
