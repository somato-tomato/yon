                        ...
                        <div class="card-body">
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input readonly type="text" class="form-control" name="nomorPPMJ" id="nomorPPMJ" value="{{ $data->nomorPPMJ }}">
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="tanggalPPMJ">Tanggal PPMJ</label>
                                    <input readonly type="text" class="form-control" name="tanggalPPMJ" id="tanggalPPMJ" value="{{ $data->tanggalPPMJ }}">
                                </div>
                            </div>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input readonly type="text" class="form-control" name="dasarPP" id="dasarPP" value="{{ $data->dasarPP }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="tanggalPP">Tanggal PP</label>
                                    <input readonly type="text" class="form-control" name="tanggalPP" id="tanggalPP" value="{{ $data->tanggalPP }}">
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="tanggalPO">Tanggal PO</label>
                                    <input readonly type="text" class="form-control" name="tanggalPO" id="tanggalPO" value="{{ $data->tanggalPO  }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input readonly type="text" class="form-control" id="tujuanSurat" name="tujuanSurat" value="{{ $data->tujuanSurat }}">
                            </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input readonly type="text" class="form-control" name="nomorPO" id="nomorPO" value="{{ $data->nomorPO }}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="namaOrder">Nama Order</label>
                                    <input readonly type="text" class="form-control" name="namaOrder" id="namaOrder" value="{{ $data->namaOrder }}">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="jumlahOrder">Jumlah Order</label>
                                    <input readonly type="text" class="form-control" name="jumlahOrder" id="jumlahOrder" value="{{ $data->jumlahOrder }}">
                                </div>
                            </div>
                        </div>
                    </div>
