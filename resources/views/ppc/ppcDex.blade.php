            ...
            <div class="col">
                <div class="card shadow">
                    ...
                    <div class="table-responsive">
                        <table class="table table-flush table-hover" id="ppc-table" style="width: 100%">
                            <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center">Status Manager</th>
        ...
        $(function() {
            $('#ppc-table').DataTable({
                ...
                columns: [
                    ...
                    {
                        data: 'cekManager', name: 'cekManager'
                    },
                    {
                        data: 'cekLogistik', name: 'cekLogistik'
                    }
                ]
            });
        });
