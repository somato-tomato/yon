                        ...
                        <div class="card-body">
                            <div id="dynamicTable">
                                <div hidden class="form-group">
                                    ...
                                    <input readonly type="text" class="form-control" name="addmore[0][idPPC]" id="idPPC" value="1">
                                </div>
    ...
    <script type="text/javascript">
        ...
        $("#add").click(function(){
            ...
            $("#dynamicTable").append(
                ...
                '<div hidden class="form-group">' +
                '<label for="idPPC">idPPC</label>' +
                '<input readonly type="text" class="form-control" name="addmore['+i+'][idPPC]" id="idPPC" value="1">' +
                '</div>' +
                '<div class="form-group">' +
                '<label for="namaMaterial">Nama Material</label>' +
        ...
        $("#jumlahMaterial,#satuanHarga").keyup(function () {
            $('#jumlahHarga').val($('#jumlahMaterial').val() * $('#satuanHarga').val());
        });
    </script>
    <script type="text/javascript">
